  ...
  if (puerta) {
    return (
      <div className="bg-[#090524] h-screen w-screen flex flex-col items-center justify-center font-['Source Sans Pro']">
        <label className="text-white text-3xl font-bold font-['Source Sans Pro']">Ingresa tu nombre de usuario</label>
        <input type="text" onChange={(e) => captura_nombre(e.target)} placeholder="Type here" className="input input-bordered w-full max-w-xs" />
        <button
          onClick={() => {
            setpuerta(false);
          }}
